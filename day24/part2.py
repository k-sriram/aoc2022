...
def compute(s: str) -> int:
    ...
    path1 = len(get_path_bfs(blizzards, start, end, 1)) - 1
    path2 = len(get_path_bfs(blizzards, end, start, 1 + path1)) - 1
    path3 = len(get_path_bfs(blizzards, start, end, 1 + path1 + path2)) - 1
